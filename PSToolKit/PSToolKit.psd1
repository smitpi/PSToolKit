...
FunctionsToExport = 'Add-ChocolateyPrivateRepo', 'Backup-ElevatedShortcut', 
               ...
               'Get-ModuleCommandHelp', 'Get-MyPSGalleryStats', 'Get-NestedMember', 
               'Get-ProcessPerformance', 'Get-PropertiesToCSV', 'Get-RemoteUptime', 
               'Get-SoftwareAudit', 'Get-SystemInfo', 'Get-WinEventLogExtract', 
               ...
               'Set-TempFolder', 'Show-ComputerManagment', 'Show-PSToolKit', 
