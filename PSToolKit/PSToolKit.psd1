...
#
# Generated on: 2022-09-27 19:46:22Z
#
...
FunctionsToExport = 'Add-ChocolateyPrivateRepo', 'Backup-ElevatedShortcut', 
               ...
               'Get-CitrixPolicy', 'Get-CommandFiltered', 'Get-DeviceUptime', 
               'Get-FolderSize', 'Get-FQDN', 'Get-FullADUserDetail', 
               'Get-MyPSGalleryReport', 'Get-MyPSGalleryStat', 
               'Get-NestedADGroupMember', 'Get-ProcessPerformance', 
               ...
               'Remove-UserProfile', 'Reset-Module', 'Reset-PSGallery', 'Resolve-SID', 
               ...
               'Show-ComputerManagement', 'Show-MyPSGalleryModule', 'Show-PSToolKit', 
               ...
               'Write-Message', 'Write-PSToolKitLog', 'Write-PSToolKitReport'
...
PrivateData = @{
    ...
    PSData = @{
        ...
        ReleaseNotes = 'Updated [27/09/2022_19:46] Renamed scripts to single name'
