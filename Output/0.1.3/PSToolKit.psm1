...
Function Set-PSProjectFiles {
 ...
 try {
	...
	$file | Set-Content -Path $rootModule -Encoding utf8 
	...
	$ScriptAnalyzerIssues | Export-Excel -Path $ModuleIssuesExcel -WorksheetName ScriptAnalyzer -AutoSize -AutoFilter -BoldTopRow -FreezeTopRow -PivotTableName Summery -PivotRows RuleName -PivotData Message
...
#region Show-ComputerManagment.ps1
############################################
# source: Show-ComputerManagment.ps1
# Module: PSToolKit
# version: 0.1.3
# Author: Pierre Smit
# Company: HTPCZA Tech
...
Export-ModuleMember -Function Show-ComputerManagment
#endregion
