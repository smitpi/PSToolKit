...
<<<<<<< HEAD:Output/0.1.17/PSToolKit.psd1
ModuleVersion = '0.1.17'
=======
ModuleVersion = '0.1.16'
>>>>>>> 92a8c8f912d8b122bae0369caf33eece64ce219a:Output/0.1.16/PSToolKit.psd1
...
FunctionsToExport = 'Add-ChocolateyPrivateRepo', 'Backup-ElevatedShortcut', 
               ...
               'Edit-ChocolateyAppsList', 'Edit-HostsFile', 'Edit-PSModulesLists', 
...
<<<<<<< HEAD:Output/0.1.17/PSToolKit.psd1
               'Get-CitrixClientVersions', 'Get-CommandFiltered', 'Get-DeviceUptime', 
               'Get-FolderSize', 'Get-FQDN', 'Get-FullADUserDetail', 
               'Get-MyPSGalleryStats', 'Get-ProcessPerformance', 
               ...
               'Install-CitrixCloudConnector', 'Install-MSWinget', 'Install-PS7', 
               'Install-PSModules', 'Install-PSWinUpdates', 'Install-RSAT', 
...
=======
               ...
               'Get-MyPSGalleryStats', 'Get-NestedMember', 'Get-ProcessPerformance', 
               'Get-PropertiesToCSV', 'Get-RemoteUptime', 'Get-SoftwareAudit', 
               'Get-SystemInfo', 'Get-WinEventLogExtract', 
               'Import-CitrixSiteConfigFile', 'Import-XamlConfigFile', 
               'Install-ChocolateyApps', 'Install-ChocolateyClient', 
               'Install-ChocolateyServer', 'Install-CitrixCloudConnector', 
               'Install-MSWinget', 'Install-PS7', 'Install-PSModules', 
               'Install-PSWinUpdates', 'Install-RSAT', 'Install-SSHServer', 
               'Install-WindowsTerminal', 'New-CitrixSiteConfigFile', 
               'New-ElevatedShortcut', 'New-GodModeFolder', 'New-PSModule', 
               'New-PSProfile', 'New-PSScript', 'Remove-CIMUserProfiles', 
...
>>>>>>> 92a8c8f912d8b122bae0369caf33eece64ce219a:Output/0.1.16/PSToolKit.psd1
               ...
               'Update-PSToolKit', 'Update-PSToolKitConfigFiles', 
               'Write-PSToolKitLog'
