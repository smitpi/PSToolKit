...
# Module: PSToolKit
<<<<<<< HEAD:Output/0.1.17/PSToolKit.psm1
# version: 0.1.17
=======
# version: 0.1.16
>>>>>>> 92a8c8f912d8b122bae0369caf33eece64ce219a:Output/0.1.16/PSToolKit.psm1
# Author: Pierre Smit
# Company: HTPCZA Tech
#############################################
...
=======
		Write-Host (' {0,23} ' -f 'Module Paths Details') -ForegroundColor DarkRed
		Write-Host '--------------------------------------------------------' -ForegroundColor DarkGray
...
=======
		Write-Host (' {0,-20} ' -f "$($weather.currentConditions.comment), Tempreture:$($weather.currentConditions.temp.c)°C, Wind:$($weather.currentConditions.wind.km)km/h") -ForegroundColor Green
>>>>>>> 92a8c8f912d8b122bae0369caf33eece64ce219a:Output/0.1.16/PSToolKit.psm1
		Write-Host ("[$((Get-Date -Format HH:mm:ss).ToString())]") -ForegroundColor DarkYellow -NoNewline
