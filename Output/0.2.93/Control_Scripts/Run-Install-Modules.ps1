...
(New-Object System.Net.WebClient).DownloadFile(`$(`$Url), "C:\Temp\Install-ModulesFromPWSHModule.ps1")
Import-Module (Get-Item "C:\Temp\Install-ModulesFromPWSHModule.ps1").fullname -Force; Install-ModulesFromPWSHModule
"@ -Verbose -Force
...
"@ -Verbose -Force
	...
	Start-Sleep 10
	$run, $RunUser, (Get-Item 'C:\Temp\Install-ModulesFromPWSHModule.ps1') | Remove-Item -Force
} else {
	$URL = 'https://raw.githubusercontent.com/smitpi/PSToolKit/master/PSToolKit/Public/Install-ModulesFromPWSHModule.ps1'
