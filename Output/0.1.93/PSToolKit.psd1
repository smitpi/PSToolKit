...
#
<<<<<<<< HEAD:Output/0.1.95.2/PSToolKit.psd1
# Generated on: 2022-09-10 06:58:55Z
========
# Generated on: 2022-09-09 02:55:07Z
>>>>>>>> 2df06de0764d0010d272f3fe555c4f8121a970af:Output/0.1.93/PSToolKit.psd1
#
...
FunctionsToExport = 'Add-ChocolateyPrivateRepo', 'Backup-ElevatedShortcut', 
               ...
               'Connect-VMWareCluster', 'Edit-SSHConfigFile', 
               'Enable-RemoteHostPSRemoting', 'Export-ESXTemplate', 
               'Find-ChocolateyApp', 'Find-OnlineModule', 'Find-OnlineScript', 
               'Format-AllObjectsInAListView', 'Get-CitrixClientVersion', 
               'Get-CitrixPolicies', 'Get-CommandFiltered', 'Get-DeviceUptime', 
               'Get-FolderSize', 'Get-FQDN', 'Get-FullADUserDetail', 
               'Get-MyPSGalleryReport', 'Get-MyPSGalleryStat', 
               'Get-NestedADGroupMembers', 'Get-ProcessPerformance', 
               'Get-PropertiesToCSV', 'Get-SoftwareAudit', 'Get-SystemInfo', 
               'Get-WinEventLogExtract', 'Import-CitrixSiteConfigFile', 
               'Import-XamlConfigFile', 'Install-BGInfo', 'Install-ChocolateyClient', 
               ...
               'New-PSGenericList', 'New-PSModule', 'New-PSProfile', 
               'New-PSReportingScript', 'New-PSScript', 'New-SuggestedInfraName', 
               'Publish-ModuleToLocalRepo', 'Remove-CIMUserProfile', 
               'Remove-FaultyProfileList', 'Remove-HiddenDevice', 
               'Remove-UserProfile', 'Reset-PSGallery', 'Resolve-SID', 
               'Restore-ElevatedShortcut', 'Save-PSModules', 'Search-Script', 
               'Set-FolderCustomIcon', 'Set-PSToolKitSystemSetting', 
               'Set-SharedPSProfile', 'Set-StaticIP', 'Set-TempFolder', 
               'Set-VSCodeExplorerSortOrder', 'Set-WindowsAutoLogin', 
               'Show-ComputerManagement', 'Show-MyPSGalleryModules', 
               'Show-PSToolKit', 'Start-PowerShellAsAdmin', 'Start-PSProfile', 
               ...
               'Update-MyModulesFromGitHub', 'Update-PSDefaultParameter', 
               'Update-PSModuleInfo', 'Write-Ascii', 'Write-Message', 
               'Write-PSToolKitLog', 'Write-PSToolKitReport'
...
<<<<<<<< HEAD:Output/0.1.95.2/PSToolKit.psd1
        ReleaseNotes = 'Updated [10/09/2022_06:58] Updated Module Online Help Files'
========
        ReleaseNotes = 'Updated [09/09/2022_02:55] And again'
>>>>>>>> 2df06de0764d0010d272f3fe555c4f8121a970af:Output/0.1.93/PSToolKit.psd1
