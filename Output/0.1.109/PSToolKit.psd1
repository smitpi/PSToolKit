...
#
# Generated on: 2022-10-15 10:22:36Z
#
...
FunctionsToExport = 'Add-ChocolateyPrivateRepo', 'Backup-ElevatedShortcut', 
               ...
               'Get-CitrixClientVersion', 'Get-CitrixPolicy', 'Get-CommandFiltered', 
               'Get-FolderSize', 'Get-FQDN', 'Get-FullADUserDetail', 
               'Get-MyPSGalleryReport', 'Get-MyPSGalleryStat', 
               'Get-NestedADGroupMember', 'Get-ObjectProperties', 
               'Get-ProcessPerformance', 'Get-PropertiesToCSV', 'Get-PSObject', 
               'Get-SoftwareAudit', 'Get-SystemInfo', 'Get-SystemUptime', 
               ...
               'Write-Message', 'Write-PSReports', 'Write-PSToolKitLog'
...
PrivateData = @{
    ...
    PSData = @{
        ...
        ReleaseNotes = 'Updated [15/10/2022_10:22] Changed Report script'
