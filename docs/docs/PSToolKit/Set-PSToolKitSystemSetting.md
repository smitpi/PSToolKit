...
HelpUri: https://smitpi.github.io/PSToolKit/Set-PSToolKitSystemSettings
Locale: en-US
Module Name: PSToolKit
ms.date: 03/09/2026
PlatyPS schema version: 2024-05-01
title: Set-PSToolKitSystemSetting
---
...
Set-PSToolKitSystemSetting [-RunAll] [-ExecutionPolicy] [-IntranetZone] [-IntranetZoneIPRange]
 ...
 [-DisableIPV6] [-DisableFirewall] [-DisableInternetExplorerESC] [-DisableServerManager]
 [-EnableRDP] [-PerformReboot] [<CommonParameters>]
```
