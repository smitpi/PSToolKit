...
HelpUri: https://smitpi.github.io/PSToolKit/Find-OnlineScript
Locale: en-US
Module Name: PSToolKit
ms.date: 02/24/2026
PlatyPS schema version: 2024-05-01
title: Find-OnlineScript
---
...
```
Find-OnlineScript [[-Keyword] <string>] [-NoAzureAWS] [-MaxCount <int>] [-Offline] [-UpdateCache]
