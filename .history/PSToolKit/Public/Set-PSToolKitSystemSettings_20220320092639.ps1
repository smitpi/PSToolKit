...
Function Set-PSToolKitSystemSettings {
    ...
    if ($RunFrequent) {
        $ExecutionPolicy = $PSGallery = $IntranetZone = $IntranetZoneIPRange = $DisableIPV6 = $FileExplorerSettings = $DisableFirewall = $DisableInternetExplorerESC = $DisableServerManager = $EnableRDP = $true
    }
