...
Function Find-ChocolateyApps {
	...
	Write-Color '[Collecting] ', 'Top ', "$($SelectTop) ","apps"," ($($SearchString))" -Color Yellow, Cyan, Yellow,Cyan,Yellow
=
	choco search $SearchString --limit-output --order-by-popularity --source chocolatey | Select-Object -First $SelectTop
