...
function Find-OnlineModule {
	...
	$AllImport | Where-Object {$_.name -like "*$Keyword*"
	-or $_.Description -like "*$Keyword*"
	-or $_.ReleaseNotes -like "*$Keyword*"
	-or $_.Tags -like "*$Keyword*"
	-or $_.Author -like "*$Keyword*" } | ForEach-Object {
	...
	$NewObject | Sort-Object -Property downloadCount -Descending
}
