...
Function Set-PSToolKitSystemSettings {
    ...
    if ($RunFrequent) {
        $ExecutionPolicy = $PSGallery = $IntranetZone = $IntranetZoneIPRange = $DisableIPV6 = $FileExplorerSettings = $DisableFirewall = $EnableRDP = $DisableInternetExplorerESC = $DisableServerManager = $true
    }
