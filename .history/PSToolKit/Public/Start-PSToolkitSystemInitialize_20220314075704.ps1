...
Function Start-PSToolkitSystemInitialize {
	...
	if ($LabSetup) {
		...
		Set-PSToolKitSystemSettings -PSTrustedHosts -FileExplorerSettings -DisableIPV6 -DisableFirewall -DisableInternetExplorerESC -DisableServerManager -EnableRDP -InstallVMWareTools -InstallAnsibleRemote -EnableNFSClient
